...
export default function Navbar({ activeTab, setActiveTab, isAdmin, isShrunk }) {
  const navItems = [
    { id: 'home', icon: Home },
            ...
            <button 
              ...
              className={`
                ...
                ${activeTab === item.id 
                  ...
                  : 'opacity-40 hover:opacity-100 hover:text-[rgb(var(--theme-primary))] active:scale-95'}
              `}
            >
              <item.icon 
                size={isShrunk ? 18 : 20} 
              ...
              {activeTab === item.id && !isShrunk && (
                <div className="absolute -bottom-1 w-1 h-1 bg-[rgb(var(--theme-primary))] rounded-full shadow-[0_0_8px_var(--theme-primary-glow)] animate-pulse" />
              )}
            </button>
          )
        ))}
