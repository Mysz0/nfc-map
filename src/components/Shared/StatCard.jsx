...
export default function StatCard({ mainVal = 0, subVal = 0, streak = 0, colors }) {
  ...
  return (
    <div className={`${colors.card} backdrop-blur-2xl rounded-[3rem] p-6 border border-white/5 flex justify-between items-center transition-all duration-700 shadow-2xl gap-2`}>
      ...
      <div className="text-center px-2 shrink-0">
        ...
        <p className="text-zinc-500 text-[7px] font-black uppercase mt-2 tracking-widest whitespace-nowrap">
          Nodes
        </p>
      </div>
      ...
      <div className="flex-1 min-w-0 flex flex-col items-end">
        ...
        <p className="text-orange-500/50 text-[7px] font-black uppercase mt-2 tracking-widest whitespace-nowrap text-right">
          Day Streak
        </p>
      </div>
    </div>
